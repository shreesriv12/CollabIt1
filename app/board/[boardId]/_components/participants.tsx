...
export const ParticipantsSkeleton = () => {
  return (
    <div
      className="w-[100px] absolute h-12 top-2 right-2 bg-white dark:bg-neutral-800 rounded-lg p-3 flex items-center shadow-lg border border-gray-200 dark:border-neutral-700 z-30"
      aria-hidden
    />
  );
};
